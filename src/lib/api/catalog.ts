  ...
  const vendor: Vendor = partner
    ? (() => {
        ...
        return {
          ...
          nameEn: partner.vendorNameEn || partner.vendorNameAr || "",
          city: partner.city || "",
          cityEn: (partner as any).cityEn || (partner as any).city_en || partner.city || "",
          address: partner.addressAr || "",
          addressEn: (partner as any).addressEn || (partner as any).address_en || partner.addressAr || "",
          aboutAr: partner.aboutAr || "",
          aboutEn: partner.aboutEn || partner.aboutAr || "",
